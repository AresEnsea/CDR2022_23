...
extern uint8_t sideFrameText[32];
extern uint8_t middleFrameText[32];
extern uint8_t startContent[8];
extern uint8_t middleContent[10];
extern uint8_t chiffres[16];
